...
index_operator: LSB exp0 RSB index_operator
				|LSB exp0 RSB ;
operands
	: literal
	| ID
...
stmt_callMethod: (exp9 DOT ID LB list_param RB|ID ACCESS Dollar_ID LB list_param RB) SEMI;
// Block statement
...
stt_method: exp0 ACCESS Dollar_ID LB list_param RB ;
